    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.println("For which player do you need statistics? ");
                String requestedPlayer = reader.nextLine();
                NHLStatistics.searchByPlayer(requestedPlayer);
            } else if (command.equals("club")) {
                // Ask the user first which club's statistics are needed and then print them.
                System.out.println("For which team do you need statistics? ");
                String requestedTeam = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(requestedTeam);
